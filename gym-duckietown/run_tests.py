...
env = gym.make("Duckietown-loop_empty-v0")#Duckietown-udem1-v0
env.reset()
...
env = DuckietownEnv(map_name="loop_empty", draw_bbox=True)#udem1
env.render("rgb_array")
env = DuckietownEnv(map_name="loop_empty", draw_bbox=True)#loop_obstacles
env.render("rgb_array")
