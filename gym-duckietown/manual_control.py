...
from gym_duckietown.simulator import bezier_draw_line
from gym_duckietown.simulator import bezier_draw_points_curve
from gym_duckietown.simulator import draw_point
from gym_duckietown.simulator import get_dir_vec
from gym_duckietown.simulator import get_tiles
...
class LINED(DuckietownEnv):
    ...
    def get_distance(self):
        ...
        print("THE LINE DISTANCE IS: ", dist )
...
def tuple_type(strings):
    ...
    mapped_bool = map(bool, strings.split(","))
...
parser.add_argument("--dataset_gen", type=tuple_type)
